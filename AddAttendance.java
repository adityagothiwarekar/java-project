...
public class AddAttendance implements Initializable {
    ...
    public ObservableList<StudentData3> getStudentdata3() {
        ...
        try {
            ...
            while (rs.next()) {
                studentData3 = new StudentData3(rs.getString("roll_no"), rs.getString("course_id"), rs.getString("lesson_id"), rs.getDate("date"));
    ...
    public void showData() {
        ...
        roll_no.setCellValueFactory(new PropertyValueFactory<StudentData3, String>("roll_no"));
    ...
    private void insertRecord() throws SQLException {
        String query = "INSERT INTO `ams2.0`.`absent_register` ( `lesson_id`, `roll_no`, `date`, `course_id`) VALUES (?,?,?,?)";
    ...
    public void updatestudents() throws SQLException {
        ...
        String sql = "UPDATE absent_register SET lesson_id = '"
                + lesson_no.getText() + "', course_id = '"
                + coursebox.getSelectionModel().getSelectedItem() + "', date = '" + select_date.getValue()+ "' WHERE roll_no ='"
                + roll_number.getText() + "'";
    ...
    public void addEmployeeDelete() {
        ...
        String sql = "DELETE FROM absent_register WHERE roll_no = '"
                + roll_number.getText() + "'";
        ...
        try {
            ...
            if (roll_number.getText().isEmpty()
                ...
                if (option.get().equals(ButtonType.OK)) {
                    ...
                    String deleteInfo = "DELETE FROM absent_register WHERE roll_no = '"
                            + roll_number.getText() + "'";
